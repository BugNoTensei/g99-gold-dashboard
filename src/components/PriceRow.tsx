...
export default function PriceRow({ label, type = "buy", price }: Props) {
  ...
  return (
    <div className="flex items-center mb-[1vh] md:mb-[1.5vh] h-[clamp(40px,10vh,110px)] md:h-[12vh] w-full shrink-0">
      ...
      <div className="flex-1 h-full bg-white flex items-center justify-end pr-[5%] text-[clamp(1.5rem,5.5vh,3rem)] md:text-[clamp(2.5rem,6.5vh,4.5rem)] font-bold text-text-dark rounded-r-[45px] shadow-[4px_4px_10px_rgba(0,0,0,0.2)] -ml-2.5 transition-colors duration-300 leading-none whitespace-nowrap font-roboto tabular-nums">
        {price
